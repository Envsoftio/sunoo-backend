...
export class AddSupportTickets1760093229198 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      DO $$ BEGIN
        CREATE TYPE "public"."support_tickets_category_enum" AS ENUM('technical', 'billing', 'account', 'feature_request', 'bug_report', 'general');
      EXCEPTION
        WHEN duplicate_object THEN null;
      END $$;
    `);
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "support_tickets" (
        ...
        "category" "public"."support_tickets_category_enum" NOT NULL DEFAULT 'general',
        ...
        "lastResponseBy" character varying,
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "support_ticket_messages" (
        ...
        "userId" uuid NOT NULL,
        CONSTRAINT "PK_c3e561853b6b303f74fde5a3e1f" PRIMARY KEY ("id")
      )
    `);
    await queryRunner.query(`
      DO $$ BEGIN
        ALTER TABLE "support_tickets" ADD CONSTRAINT "FK_8679e2ff150ff0e253189ca0253" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
      EXCEPTION
        WHEN duplicate_object THEN null;
      END $$;
    `);
    await queryRunner.query(`
      DO $$ BEGIN
        ALTER TABLE "support_ticket_messages" ADD CONSTRAINT "FK_7273de5a56e50ed6300fb7ca131" FOREIGN KEY ("ticketId") REFERENCES "support_tickets"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
      EXCEPTION
        WHEN duplicate_object THEN null;
      END $$;
    `);
    await queryRunner.query(`
      DO $$ BEGIN
        ALTER TABLE "support_ticket_messages" ADD CONSTRAINT "FK_4b66c2bd038f7cf9e096e78102d" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
      EXCEPTION
        WHEN duplicate_object THEN null;
      END $$;
    `);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "support_ticket_messages" DROP CONSTRAINT "FK_4b66c2bd038f7cf9e096e78102d"`
    );
    await queryRunner.query(
      `ALTER TABLE "support_ticket_messages" DROP CONSTRAINT "FK_7273de5a56e50ed6300fb7ca131"`
    );
    await queryRunner.query(
